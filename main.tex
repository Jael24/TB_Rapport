...
\begin{itemize}
    \item Évaluation théorique de plusieurs systèmes de gestion de logs.
    \subitem Choix des systèmes à évaluer.
    \item Comparaison entre les différents systèmes.
    \subitem Comparaison théorique \& pratique.
    \item Choix d'un système.
    \subitem En accord avec l'entreprise mendante.
